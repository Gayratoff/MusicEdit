...
bot =Bot(token="5058492849:AAHzM5GDayLi11GYPGaYGr71x-AqoQ81dks")
dp = Dispatcher(bot)
...
async def bot_start(message: types.Message):
    ...
    await bot.send_message(chat_id=user_id, text=f"Salom Meni Kanalingizga admin qilsangiz musiqalarga kanal nomini qoyib beraman")
